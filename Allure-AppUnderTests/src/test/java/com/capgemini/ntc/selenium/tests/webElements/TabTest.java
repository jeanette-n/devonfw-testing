...
public class TabTest extends BaseTest {
    ...
    public void testSelectionSpecifiedItem(){
        tabObject = BasePage.getDriver().elementTab(TabTest.tabSelector,TabTest.tabChildsSelector,TabTest.listSelectedAttributes);
    ...
    public void setUp() {
        ...
        this.tabObject = BasePage.getDriver().elementTab(TabTest.tabSelector);
    }
