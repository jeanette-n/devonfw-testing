...
public class MenuTest extends BaseTest {
    ...
    public void testMenuByIndex(){
        menuElement = BasePage.getDriver().elementMenu(MenuTest.menuSelector);
    ...
    public void testSelectSubMenuItemByText(){
        BasePage.getDriver().elementButton(MenuTest.subMenuTabSelector).click();
        menu2Element = BasePage.getDriver().elementMenu(MenuTest.menu2Selector,MenuTest.menuChildsSelector,MenuTest.subMenuSelector);
    ...
    public void testSelectSubMenuItemByIndex(){
        BasePage.getDriver().elementButton(MenuTest.subMenuTabSelector).click();
        menu2Element = BasePage.getDriver().elementMenu(MenuTest.menu2Selector,MenuTest.menuChildsSelector);
    ...
    public void testLinkSubMenuItemByText(){
        BasePage.getDriver().elementButton(MenuTest.subMenuTabSelector).click();
        menu2Element = BasePage.getDriver().elementMenu(MenuTest.menu2Selector,MenuTest.menuChildsSelector,MenuTest.subMenuSelector,MenuTest.subMenuChildsSelector);
        menu2Element.selectSubMenuItemByText("FAQ","Sub Menu Item 3");
    }

    @Override
    public void setUp() {
        BasePage.getDriver().get(PageSubURLsEnum.WWW_FONT_URL.subURL() + PageSubURLsEnum.MENU.subURL());
    }
